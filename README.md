...
2. Clone the repo
   ```sh
   git clone https://github.com/weandwebk19/nft-bookstore
   ```
...
4. In the root folder of the application create a `.env.development` file with following content:
...
5. Then migrate a contract to Ganache, contract can be found in the `contracts` folder. It's called `NftBookstore.sol`
...
6. Now everything is setup and you can test out the app.
