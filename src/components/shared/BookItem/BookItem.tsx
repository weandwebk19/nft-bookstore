  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography className="text-limit text-limit--2" variant="h6" sx={{ flex: 1 }}>
            {meta.title}
          </Typography>
          <Typography className="text-limit text-limit--1" variant="body2" sx={{ flexShrink: 0, marginTop: "auto" }}>
            {author}
          </Typography>
        </Box>
      </Box>
